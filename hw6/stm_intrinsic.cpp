...
int main(int, char**)
{
  ...
  // guessed camera matrix and distortion coefficient
  Mat M = (Mat_<double>(3,3) << 825.0900600547, 0, 331.6538103208, 0, 824.2672147458, 252.9284287373, 0, 0, 1);
  ...
  undistortPoints(first_good, first_undistorted, M, distCoeffs);
  undistortPoints(next_good, last_undistorted, M, distCoeffs);
